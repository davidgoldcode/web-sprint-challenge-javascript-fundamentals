...
zooAnimals.forEach(function(item) {
    return displayNames.push(`Scientific: ${item.animal_name}, Name: ${item.scientific_name}`);
})
...
//     return `Hell ${firstName} ${lastName}, nice to meet you!`
// }

let greeting = (firstName, lastName) => `Hell ${firstName} ${lastName}, nice to meet you!`;
